...
<svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='cursor-pointer hover:fill-[red]'>
<g id="SVGRepo_bgCarrier" strokeWidth="0" className='cursor-pointer hover:fill-[red]'/>
<g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" className="cursor-pointer hover:fill-[red]"/>
